...
export default function Essentiel() {
    ...
    return (
        <div>
            <div className="flex xl:flex-row flex-col mt-20 ml-10">
            ...
            <button className="xl:ml-0 ml-10 mt-6 bg-brown-click w-60 h-10 flex justify-center items-center rounded-md" onClick={infoForm.toggledForm}>
                <div className="text-white text-l no-underline">Demander à être rappelé.e</div>
            </button>
            <div className="xl:ml-0 ml-10 mt-6 xl:mt-12 text-l flex flex-col xl:flex-row justify-between tracking-wider">
                ...
                <div className="bg-white h-28 lg:w-7/12 mr-10 flex items-center justify-between rounded-md">
